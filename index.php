...
<body>
    ...
    <form class="w3-container" method="post" action="atividadeOnlineAction.php">
        <label class="w3-text-teal"><b>Nome do Cliente:</b></label>
			<input class="w3-input w3-border w3-light-grey" name="txtNome" type="text" style="width: 700px" autocomplete="off" required>
        <label class="w3-text-teal"><b>Valor da Compra:</b></label>
			<input class="w3-input w3-border w3-light-grey" name="txtValorCompra" type="text" style="width: 100px" required>
        <label class="w3-text-teal"><b>Escolha a forma de Pagamento:</b></label>
			<select class="w3-input w3-border w3-light-grey"  name ="cmbPag" style="width: 200px" required>
